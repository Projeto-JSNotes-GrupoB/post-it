...
function FormNotas(_ref) {
    ...
    var notaAlterada = new _nota2.default(notaAtual.titulo, notaAtual.texto, notaAtual.editando, posicao);
    var inputTitulo = criaInputTitulo(notaAlterada, posicao);
    var textareaTexto = criaTextareaTexto(notaAlterada, posicao);
...
var Page = function (_React$Component) {
    ...
    _createClass(Page, [{
        ...
        value: function render() {
            ...
            var secaoNotas = montaSecaoNotas(this.state.listaNotas, this.adicionarNota, this.removerNota, this.editarFormulario);
...
function SecaoNotas(_ref) {
    ...
    return _react2.default.createElement(
        ...
        listaNotas.pegaTodos().map(function (notaAtual, posicao) {
            return criaFormNotas(posicao, listaNotas, adicionarNota, removerNota, editarFormulario);
        })
    );
}
