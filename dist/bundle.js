...
var _secaoNotas = __webpack_require__(19);
...
var props = { listaNotas: listaNotas, formNotas: formNotas, adicionarNota: adicionarNota, removerNota: removerNota, editarFormulario: editarFormulario };
secao.appendChild(new _secaoNotas2.default(props));
...
var _formInput = __webpack_require__(16);
...
function criaButtonConcluir(adicionarNota, posicao, notaAlterada) {
    ...
    var props = {
        ...
        } // target guarda a tag que sofreu o evento
    };
...
function criaButtonRemover(posicao, removerNota) {
    ...
    return _react2.default.createElement(_formButton2.default, props);
}
...
function FormNotas(_ref) {
    ...
    var inputTitulo = criaInputTitulo(notaAlterada);
    var textareaTexto = criaTextareaTexto(notaAlterada);

    var props = { className: 'note' }; //não precisa mais formProps pq eu mudei os parâmetros do FormNotas, desestruturando em 5 variáveis.
    var children = void 0;

    if (notaAlterada.editando) {
        var buttonConcluido = criaButtonConcluir(adicionarNota, posicao, notaAlterada);
        ...
        props.onClick = function () {
            return editarFormulario(props.posicao);
        };
    }
...
var _formNotas2 = __webpack_require__(3);

var _formNotas3 = _interopRequireDefault(_formNotas2);
...
function criaFormNotas(listaNotas, posicao, removerNota, dicionarNota, editarFormulario) {
    ...
    return _react2.default.createElement(_formNotas3.default, props);
}

function SecaoNotas(_ref) {
    var listaNotas = _ref.listaNotas,
        formNotas = _ref.formNotas,
        adicionarNota = _ref.adicionarNota,
        removerNota = _ref.removerNota,
        editarFormulario = _ref.editarFormulario;
    // destructuring
    ...
    for (var posicao = 0; posicao < listaNotas.contaTotal(); posicao++) {
        ...
        var _formNotas = _react2.default.createElement(_formNotas3.default, _props);
        children.push(_formNotas);
    }
